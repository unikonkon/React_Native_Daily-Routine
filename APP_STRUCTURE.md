...
| **สัปดาห์** | ตาราง 7 คอลัมน์ (จันทร์เริ่ม) 06:00–30:00 (ครบ 24 ชม.) บล็อกสีตามหมวด — ทึบเมื่อ done, จาง 60% เมื่อ planned, 35% เมื่อ rescheduled — หัวแถบ "6 ก.ค. – 12 ก.ค. 2569" + ‹ › | swipe = ±7 วัน, แตะวัน → โหมดวัน |
...
- หน้าต่างเวลา **06:00–30:00 ครบ 24 ชม.** (360–1800 นาที; เวลาเกิน 24:00 ได้ เช่น 26:00 = 02:00 วันถัดไป แสดง "+วันถัดไป")
- สเกล **0.82 px/นาที**, เส้นบอกชั่วโมงทุก 1 ชม. (รวมชั่วโมงเลขคี่) เริ่ม 06:00, ร่องป้ายเวลา 44px
...
**นิยาม slot ว่าง**: หน้าต่างวัน **06:00–30:00 (ครบ 24 ชม.)** — เดินตามกิจกรรม (planned+done) เรียงเวลาเริ่ม ช่องว่างระหว่างกัน **≥ 45 นาที** (หรือ ≥ ความยาวที่ร้องขอ) = ว่าง — engine ตัวเดียวกันนี้ใช้กับ พรีวิวแท็บ 2 และ Reschedule (3.4)
...
- เวลาทุกจุด **snap 15 นาที**, หน้าต่างวัน 06:00–30:00 (ครบ 24 ชม.)
...
ส่วนที่ **ยึดตาม prototype เป๊ะ**: โครง 4 แท็บ + FAB, วิซาร์ด 2 ขั้น, หน้าต่างเวลา 06:00–30:00 (ครบ 24 ชม.) + ข้ามเที่ยงคืน, snap 15 นาที, slot ว่าง ≥45 นาที, สูตรคะแนน reschedule, conflict แบบเตือนไม่บล็อก, soft-delete เก็บประวัติ, งบแจ้งเตือน 50, สรุปเช้า 06:00, ปี พ.ศ., จันทร์เริ่มสัปดาห์, สี/ฟอนต์/แอนิเมชันทั้งหมด (§10)
