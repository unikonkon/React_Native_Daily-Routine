        ...
        <Card tone="card2" style={{ gap: 12 }}>
          ...
          <View style={{ gap: 6 }}>
            ...
            <CheckRow
              ...
              sub="ภาพรวม · แนวโน้ม · ชั่วโมงตามหมวด · สรุปหมวดหมู่ (ครบทุกหมวด บอกใช้งาน/ไม่ใช้งาน + กิจกรรมยอดฮิต + ตัวเลือกย่อย) · นัดเคส · รายการนัด"
              on={withReport}
              onPress={() => {
            ...
            {shOpen ? (
              <View style={{ gap: 12 }}>
                ...
                <View style={{ gap: 6 }}>
                  ...
                  <CheckRow
                    label="รายงานสรุปจากที่บันทึกไว้"
                    sub="2 แท็บหน้าสุด: “รายงานสรุป” (ภาพรวม/แนวโน้ม/สรุปหมวดหมู่ครบทุกหมวด ใช้งาน-ไม่ใช้งาน) · “สรุปเคส & รายชื่อ” (รวมรายการนัด)"
                    on={shReport}
                    onPress={() => {
                      const next = !shReport;
                      setShReport(next);
